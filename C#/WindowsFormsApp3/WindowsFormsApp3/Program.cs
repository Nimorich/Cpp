...
class MyForm : Form
{
    ...
    //на придется обращаться к нему из разных методов 
    ListBox listBox1;
    ...
    public MyForm()
    {
        ...
        Bitmap image1 = new Bitmap("D://Foto//Piramida.jpg");
        Bitmap image2 = new Bitmap("D://Foto//Osen.jpg");
        ...
        if (listBox1.SelectedItem == "Степь")
        {
