...
class FormWithManyControls: Form
{
    ...
    public FormWithManyControls()
    {
        ...
        this.Test = "Форма, включающая различные элементы управления!";
...
private void treeView1_AfterSelect(object sender, System.Windows.Forms.TreeViewEventArgs e)
{
    ...
    else if (e.Node.Text == "Label")
    {
        ...
        label1.Text = "Это метка. Используется для вывода текста на экран!";
...
else if(else.Node.Text == "RadioButton")
{
...
else if (e.Node.Text == "TabControl")
{
    ...
    pictureBox1.Image = new Bitmap("D://Foto//5E8x_-ZpNX8.jpg");

    pictureBox1.Size = new Size(300, 200);
    tabPage1.Controls.Add(pictureBox1);
    Label lavelV = new Label();
    lavelV.Top = 200;
    lavelV.Size = new Size(300, 50);
    lavelV.Text = "Это Вадик! Он любит купаться и работать на компьютере!";
    ...
    labelC.Text = "Это компьютер Вадика! Пока Вадик купается, " + "он разрешает работать на компьютере ящерице!";
