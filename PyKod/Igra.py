...
if (x=='1'):
  ...
  if (y=='1'):
    ...
    print ('После нажатия кнопки на землю была сброшена квантовая бомба, вы случайно уничтожили родную планету и застрелились поняв это.')
else :
  ...
  if (y=='1'):
    ...
    print ('После долгого ожидания, ваш сигнал услышали рейфы, прилетев они полакомились человечинкой')
print ('Тут и сказке конец...')
